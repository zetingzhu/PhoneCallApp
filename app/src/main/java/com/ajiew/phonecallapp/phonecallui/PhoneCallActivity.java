...
public class PhoneCallActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        tvCallNumberLabel = (TextView) findViewById(R.id.tv_call_number_label);
        tvCallNumber = (TextView) findViewById(R.id.tv_call_number);
        tvPickUp = (TextView) findViewById(R.id.tv_phone_pick_up);
        tvCallingTime = (TextView) findViewById(R.id.tv_phone_calling_time);
        tvHangUp = (TextView) findViewById(R.id.tv_phone_hang_up);
